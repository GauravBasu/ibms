...
@section('action-content')
  ...
  <div class="box-body">
    ...
    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                ...
                <th width="20%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Created At</th>
            ...
            <tfoot>
              <tr>
                ...
                <th class="hidden-xs" width="20%" rowspan="1" colspan="1">Created At</th>
      ...
      <div class="row">
        <div class="col-sm-5">
          <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">Showing 1 to {{count($users)}} of {{$users->total()}} entries</div>
        </div>
        <div class="col-sm-7">
