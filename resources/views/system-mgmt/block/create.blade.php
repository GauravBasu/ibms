        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('block.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="district_id" id="sub_district_id">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="subdivision_id" id="subdivision_id">
                        ...
                        <div class="form-group{{ $errors->has('block_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="block_name" type="text" class="form-control" name="block_name" value="{{ old('block_name') }}" required autofocus>
