        ...
        <div class="row">   
          ...
          <div class="row">
             <div class="form-group col-md-12"><h4>ENGAGEMENT DETAILS</h4></div>
                ...
                <div class="form-group{{ $errors->has('in_date_of_establishment_of_masque') ? 'has-error' : '' }} col-md-4" >
                  <label>Date Of Establishment of Masque</label>
                  <input type="date" class="form-control label-floating is-empty" name="in_date_of_establishment_of_masque" id="in_date_of_establishment_of_masque" value="" placeholder="Date" />
                  @if ($errors->has('in_date_of_establishment_of_masque'))
                  <span class="requiredfield">
                  <strong>{{ $errors->first('in_date_of_establishment_of_masque') }}</strong>
                  </span>
                 @endif
                </div>

                <div class="form-group{{ $errors->has('in_supporting_document_of_masque') ? 'has-error' : '' }} col-md-4">
                 <label>Supporting Document Establishment of Masque</label>
                 <input type="file" name="in_supporting_document_of_masque" value=""  id="in_supporting_document_of_masque" class="filestyle ">
                  @if ($errors->has('in_supporting_document_of_masque'))
                  <span class="requiredfield">
                  <strong>{{ $errors->first('in_supporting_document_of_masque') }}</strong>
                  </span>
                 @endif
                 <p>(Photo must be format mention)</p>
                </div>
             ...
             <div class="form-group col-md-12"><h4>OTHER INFORMATION</h4> </div>
                ...
                <div class="form-group col-md-12">
                  <label>Particulars of previous Imam / muazzin for whom stop payment is required.(Particulars to be collected from majid  committee concerned and / or may also be mentioned in the resoltion of masjid committee while changing the Imam / Mouazzins.)</label>
                </div>
              
                <div class="form-group{{ $errors->has('in_board_of_wakfs') ? 'has-error' : '' }} col-md-4">
                 <label>Name</label>
                 <input type="text" name="in_board_of_wakfs"  class="form-control" id="in_board_of_wakfs" placeholder="Name Board of Wakf" value="" />
                 @if ($errors->has('in_board_of_wakfs'))
                  <span class="requiredfield">
                  <strong>{{ $errors->first('in_board_of_wakfs') }}</strong>
                  </span>
                 @endif
                </div>

                <div class="form-group{{ $errors->has('in_no_board_of_wakf') ? 'has-error' : '' }} col-md-4">
                 <label>Father's Name<span class="requiredStar">*</span></label>
                 <input type="text" name="in_no_board_of_wakf"  class="form-control" id="in_no_board_of_wakf" placeholder="No Board of Wakf" value=""/>
                 @if ($errors->has('in_no_board_of_wakf'))
                  <span class="requiredfield">
                  <strong>{{ $errors->first('in_no_board_of_wakf') }}</strong>
                  </span>
                 @endif
                </div>
                ...
                <div class="form-group{{ $errors->has('in_no_board_of_wakf') ? 'has-error' : '' }} col-md-4">
                 <label>IFSC Code No.<span class="requiredStar">*</span></label>
                 <input type="text" name="in_no_board_of_wakf"  class="form-control" id="in_no_board_of_wakf" placeholder="No Board of Wakf" value=""/>
                 @if ($errors->has('in_no_board_of_wakf'))
                  <span class="requiredfield">
                  <strong>{{ $errors->first('in_no_board_of_wakf') }}</strong>
                ...
                <div class="form-group{{ $errors->has('in_reason_for_chnage_replacement') ? 'has-error' : '' }} col-md-4">
                  <label>Reason for Change or Replacement <span class="requiredStar">*</span></label>
                  <input type="text" name="in_reason_for_chnage_replacement"  class="form-control" id="in_reason_for_chnage_replacement" placeholder="No Board of Wakf" value=""/>
                  @if ($errors->has('in_reason_for_chnage_replacement'))
                  <span class="requiredfield">
                  <strong>{{ $errors->first('in_reason_for_chnage_replacement') }}</strong>
                  </span>
                  @endif
                </div>

                <div class="form-group{{ $errors->has('in_sup_doc_reason_chnage_replacement') ? 'has-error' : '' }} col-md-4">
                 <label>Supporting Document Change or Replacement</label>
                 <input type="file" name="in_supporting_document_of_masque" value=""  id="in_supporting_document_of_masque" class="filestyle ">
                  @if ($errors->has('in_supporting_document_of_masque'))
                  <span class="requiredfield">
                  <strong>{{ $errors->first('in_supporting_document_of_masque') }}</strong>
                ...
                <div class="form-group{{ $errors->has('in_name_of_maswue_presidenty') ? 'has-error' : '' }} col-md-4">
                  <label>Name of Masque's President/Secy./Mutawatti<span class="requiredStar">*</span></label>
                  <input type="text" name="in_name_of_maswue_presidenty"  class="form-control" id="in_name_of_maswue_presidenty" placeholder="No Board of Wakf" value=""/>
                  @if ($errors->has('in_name_of_maswue_presidenty'))
                  <span class="requiredfield">
                  <strong>{{ $errors->first('in_name_of_maswue_presidenty') }}</strong>
                  </span>
                  @endif
                </div>
                <div class="form-group{{ $errors->has('in_supporting_document_president') ? 'has-error' : '' }} col-md-4">
                 <label>Supporting Document President/Secy./Mutawatti</label>
                 <input type="file" name="in_supporting_document_president" value=""  id="in_supporting_document_president" class="filestyle " required>
                 @if ($errors->has('in_supporting_document_president'))
                  <span class="requiredfield">
                  <strong>{{ $errors->first('in_supporting_document_president') }}</strong>
                  </span>
                  @endif
                 <p>(Photo must be format mention)</p>
                </div>
            <div class="form-group col-md-12"><h4>MOSQUE DETAILS</h4> </div>
               ...
               <div class="form-group{{ $errors->has('in_land_supporting_document') ? 'has-error' : '' }} col-md-4">
                ...
                <div style="border:1px solid #afafaf;overflow: hidden;padding: 10px; margin:0px 15px 40px 15px;">
                  <div class="form-group{{ $errors->has('in_board_of_wakfs') ? 'has-error' : '' }} col-md-6">
                  ...
                  <div class="form-group{{ $errors->has('in_no_board_of_wakf') ? 'has-error' : '' }} col-md-6">
                   <label>No Board of Auqaf<span class="requiredStar">*</span></label>
                   <input type="text" name="in_no_board_of_wakf"  class="form-control" id="in_no_board_of_wakf" placeholder="No Board of Wakf" value=""/>
                   @if ($errors->has('in_no_board_of_wakf'))
                    <span class="requiredfield">
                    <strong>{{ $errors->first('in_no_board_of_wakf') }}</strong>
