...
//Present address and parmanent address copy
      ...
      $('#in_premises_name_number').keyup(function(e)
      {
        var present_address =  $("#in_premises_name_number").val();
       ...
       $('#in_street_localoty_name').keyup(function(e)
      {
        var present_address =  $("#in_street_localoty_name").val();
      ...
      $('#in_pre_subdivision').keyup(function(e)
      {
        var present_address =  $("#in_pre_subdivision").val();
      ...
      $('#in_village_premises').keyup(function(e)
      {
        var present_address =  $("#in_village_premises").val();
      ...
      $("#in_pre_present_pincode").blur(function(e){
        var pincode_number =  $("#in_pre_present_pincode").val()
         if ($.trim(pincode_number).length == 0 || $("#in_pre_present_pincode").val()=="" || $("#in_pre_present_pincode").val()==""){
      ...
      $('#parmanent_in_premises_name_number').keyup(function(e)
      {
        var permanent_address =  $("#parmanent_in_premises_name_number").val();
      ...
      $('#parmanent_in_street_locality_name').keyup(function(e)
      {
        var permanent_address =  $("#parmanent_in_street_locality_name").val();
      ...
      $('#parmanent_in_pre_post_office').keyup(function(e)
      {
        var permanent_address =  $("#parmanent_in_pre_post_office").val();
      ...
      $("#in_pre_parmanent_pincode").blur(function(e){
        var pincode_number =  $("#in_pre_parmanent_pincode").val()
         if ($.trim(pincode_number).length == 0 || $("#in_pre_parmanent_pincode").val()=="" || $("#in_pre_parmanent_pincode").val()==""){
